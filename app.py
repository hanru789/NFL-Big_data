...
def display_field():
    ...
    blue_players_input = []
    # Menyusun pemain biru di sebelah kiri menggunakan slider dengan rentang sumbu X (0-100)
    for i in range(11):
    ...
    red_players_input = []
    # Menyusun pemain merah di sebelah kanan menggunakan slider dengan rentang sumbu X (0-100)
    for i in range(11):
