...
def create_nfl_field():
    ...
    ax.text(2, 14, 'Offensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=90)
    ax.text(98, 14, 'Defensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=270)
