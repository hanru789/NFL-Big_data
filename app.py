...
def create_nfl_field():
    ...
    ax.text(2, 26.65, 'Offensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=90)
    ax.text(98, 26.65, 'Defensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=270)
