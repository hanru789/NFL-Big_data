...
def create_nfl_field():
    ...
    ax.text(2, 16, 'Offensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=90)
    ax.text(98, 16, 'Defensive Team', fontsize=12, ha='center', color='black', weight='bold', rotation=270)
